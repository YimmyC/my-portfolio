...
const AboutMe = () => {
  ...
  const typingSpeed = 40; // in milliseconds
  ...
  return (
    <div className="z-1 flex flex-col justify-center items-center bg-transparent shadow-md rounded-md p-6 w-full h-screen mx-auto">
